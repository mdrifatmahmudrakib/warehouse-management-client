...
const Blog = () => {
    return (
        <div className='m-5'>
            <h1 className='text-danger' >Blog</h1>
            <div class=" m-4 py-4 px-4 g-4  ">
                <div class="col m-4">
                    <div class="card h-100 shadow-lg p-3 mb-5 bg-body rounded ">

                        <div class="card-body ">
                            <h3 class="card-title ">Difference between javascript and nodejs.</h3>
                ...
                <div class="col m-4">
                    <div class="card h-100 shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">Differences between SQL and NoSQL databases.</h3>
                ...
                <div class="col m-4">
                    <div class="card h-100 shadow-lg p-3 mb-5 bg-body rounded">
                        ...
                        <div class="card-body">
                            <h3 class="card-title">What is the purpose of jwt and how does it work?</h3>
